define(function() {
  ...
  return {
    ...
    _switchBulbs:function(imgWidget1, imgWidget2, action){
      if(action === "on"){
        imgWidget1.src = "konymp_gc_bulb_on.png";
        imgWidget2.src = "konymp_gc_bulb_on.png";
      }else{
        imgWidget1.src = "konymp_gc_bulb_off.png";
        imgWidget2.src = "konymp_gc_bulb_off.png";
      }
    },

    _selectMeridian:function(meridian){
      if(meridian === "am"){
        this.view.imgAM.src = "konymp_gc_bulb_on.png";
        this.view.imgPM.src = "konymp_gc_bulb_off.png";
        this.view.lblAM.skin = "sknlblBGTransTxtYellow150";
        this.view.lblPM.skin = "sknlblBGTransTxtGrey150";
        this._meridian = "AM";
      }else{
        this.view.imgAM.src = "konymp_gc_bulb_off.png";
        this.view.imgPM.src = "konymp_gc_bulb_on.png";
