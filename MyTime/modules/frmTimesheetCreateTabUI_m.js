...
kony.apps.coe.ess.myTime.TimesheetCreate.WorkLeaveToggleTab = {
    ...
    onClickOfWork: function(callback) {
      ...
      //setting visibility on of steps
    ...
    onClickOfLeave: function(callback) {
      ...
      //setting visibility off of steps
      frmTimeSheetCreateTab.btnStep1.setVisibility(false);
      frmTimeSheetCreateTab.btnStep2.setVisibility(false);
      frmTimeSheetCreateTab.flxSelTask.setVisibility(false);
...
kony.apps.coe.ess.myTime.TimesheetCreate.HoursFullDayHalfDaySelectionTab = {
    ...
    onClickOfHoursTab: function(callback) {
        ...
        var taskName = frmTimeSheetCreateTab.flexSlider.lblTaskName.text;
        if (callback !== null && callback !== undefined && typeof(callback) === "function") {
            callback(this.selectedItem);
           	frmTimeSheetCreateTab.flexSlider.lblTaskName.text = taskName;
        }
        }
    },
    ...
    onClickOfFullDayTab: function(callback) {
        ...
        if (callback !== null && callback !== undefined && typeof(callback) === "function") {
            ...
            handleCustomAlert(kony.i18n.getLocalizedString("i18n.ess.tasksarealreadyavailable"));
        }
},
};
...
kony.apps.coe.ess.myTime.TimesheetCreate.settingTaskSummaryTab = function (dataSet, successCallBack) {
	...
	function generatingEachRowData(index) {
        finalData = {};
      finalData.time_Slot = dataSet[index].startTime + " - " + dataSet[index].endTime;
      finalData.task_Name = dataSet[index].taskName;
