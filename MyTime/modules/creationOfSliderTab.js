...
kony.apps.coe.Reusable.TimelineCreationTab.prototype.storeCoordinatesOfTimeLineTab = function () {
  ...
  frmName.flexSlider.setGestureRecognizer(constants.GESTURE_TYPE_TAP, {
    fingers : 1,
    taps : 1
  }, this.showManualTimeEntryTab.bind(this));
...
kony.apps.coe.Reusable.TimelineCreationTab.prototype.showManualTimeEntryTab = function(commonWidget, gestureInfo) {
  try {
    ...
    frmTimeSheetCreateTab.flxTimePicker.setVisibility(true);
  } catch (error) {
...
kony.apps.coe.Reusable.TimelineCreationTab.prototype.fillTimelineTab = function(data) {
  ...
  try {
    ...
    if (data.length > 0) {
      ...
      if (kony.apps.coe.ess.appconfig.isManualTimeEntry === true) {
        frmTimeSheetCreateTab.flxManualTimeSelection.setVisibility(true);
        frmTimeSheetCreateTab.tbxManualEntryhours.text = String(kony.store.getItem("defaultTaskDuration"));
        frmTimeSheetCreateTab.flxSelectionBar.setVisibility(false);
        frmTimeSheetCreateTab.flxTotalTime.setVisibility(true);
        frmTimeSheetCreateTab.flxCopy.setVisibility(false);
      }
      if (kony.apps.coe.ess.globalVariables.fullDayButtonisSelected === true || kony.apps.coe.ess.myTime.TimesheetCreate.HoursFullDayHalfDaySelection.selectedItem == 1) {
        kony.apps.coe.Reusable.TimelineCreationTab.setDefaultSlider(kony.apps.coe.ess.appconfig.fullDayStartTime, kony.apps.coe.ess.appconfig.fullDayEndTime);
    ...
    if (kony.apps.coe.ess.globalVariables.sliderLeftValue !== undefined && kony.apps.coe.ess.globalVariables.sliderLeftValue !== null && kony.apps.coe.ess.globalVariables.sliderLeftValue !== "") {
      ...
      kony.apps.coe.Reusable.TimelineCreationTab.scrollTimelineFrameSearch();
