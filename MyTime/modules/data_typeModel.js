...
// ****************Generated On Tue Nov 08 15:33:12 IST 2016data_type*******************
...
com.kony.MYAPPROVALS.data_type.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	var targetAttributes = [];
 		...
 		targetAttributes.push("id");
		//srcAttributes and targetAttributes are interchanged while calling the removecascade
		if(!kony.sync.removeCascadeHelper(tx, targetAttributes, srcAttributes, tbname, wcs, com.kony.MYAPPROVALS.attribute_def.removeCascade,"attribute_def",false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
