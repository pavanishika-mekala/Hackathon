...
function preshowfrmhome() {
    apppreshow();
    var tlobj = new kony.apps.mytime.timelineselection(frmTimeSheetCreate, frmTimeSheetCreate.flxTimeLine, frmTimeSheetCreate.segDeleteMenuPopup, frmTimeSheetCreate.btnCloneTask, 8, 10, skinconfig);
 ...
 */
kony.apps.mytime.timelineselection = function(frmname, parentflex, cancelbutton, clonebutton, dayStartAt, hoursInDay, skinconfig) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.createtimeline = function(skinsfortimeline) {
    try {
 ...
 */
kony.apps.mytime.timelineselection.prototype.enablepopup = function(source) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.onclickof_flxlneforward = function(source, x, y) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.onscroll = function() {
 ...
 */
kony.apps.mytime.timelineselection.prototype.Calculateanddraw = function() {
 ...
 */
kony.apps.mytime.timelineselection.prototype.fillData = function(data) {
        this.datafortimesheet.push(data);
    };

kony.apps.mytime.timelineselection.prototype.updateData = function(lblid)
{
...
kony.apps.mytime.timelineselection.prototype.getData = function() {
     ...
     */
kony.apps.mytime.timelineselection.prototype.ignoringflx = function(createdselectedflx) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.applyactiontoselected = function() {
 ...
 */
kony.apps.mytime.timelineselection.prototype.removeaction = function() {
    for (var i = 0; i <= 10; i++) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.isSpaceAvailable = function(source, dir) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.canceltaskcreation = function() {
    this.frmname.flxlineback.onTouchEnd = this.noaction;
    this.frmname.flxlineback.isVisible = false;
 ...
 */
kony.apps.mytime.timelineselection.prototype.animateflexto = function(x) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.ondonecreate = function() {
    this.frmname.flxscrollts.enableScrolling = true;
    this.frmname.flxlneforward.isVisible = false;
    this.frmname.flxlineback.onTouchEnd = this.noaction;
    this.frmname.flxlineback.isVisible = false;
 ...
 */
kony.apps.mytime.timelineselection.prototype.onclick_flxcreate = function() {
    this.frmname.flxscrollts.onScrolling = this.noaction;
 ...
 */
kony.apps.mytime.timelineselection.prototype.blockatscreenleft = function(flxnameRefference) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.createflex = function(basicconfig) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.startediting = function(flxsource) {
    this.removeaction();
    var source = "";
 ...
 */
kony.apps.mytime.timelineselection.prototype.addtoleft = function() {
 ...
 * @description    callback function on click of timeslots in timeline.
 */
kony.apps.mytime.timelineselection.prototype.addtoright = function() {
 ...
 */
kony.apps.mytime.timelineselection.prototype.noaction = function() {
 ...
 */
kony.apps.mytime.timelineselection.prototype.formatAMPM = function(hours) {
 ...
 */
kony.apps.mytime.timelineselection.prototype.convertTo24Hour = function(time) {
...
kony.apps.mytime.timelineselection.prototype.setfunctiontodeleteseg = function()
{
 ...
 */
kony.apps.mytime.timelineselection.prototype.deleteCurrentTimeline = function()
{
 ...
 */
kony.apps.mytime.timelineselection.prototype.deleteall = function()
{
