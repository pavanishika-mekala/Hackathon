...
// ****************Generated On Mon Dec 11 21:58:45 UTC 2017approval_request*******************
...
*		valuesArray[0].from_time = "from_time_0";
...
*		valuesArray[1].from_time = "from_time_1";
...
*		valuesArray[2].from_time = "from_time_2";
...
com.kony.MYAPPROVALS.approval_request.deleteByPK = function(pks, successcallback,errorcallback, markForUpload){
	...
	function approval_requestTransactionCallback(tx){
		...
		if (null !== record) {
			...
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYAPPROVALS.approval_audit.removeCascade,"approval_audit",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.MYAPPROVALS.approval_request.removeDeviceInstanceByPK = function(pks, successcallback,errorcallback){
	...
	function approval_requestTransactionCallback(tx){
		...
		if(null !== record && false !=record) {
			...
			srcAttributes.push("id") ;
			targetAttributes.push("request_id") ;
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYAPPROVALS.approval_audit.removeCascade,"approval_audit",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.MYAPPROVALS.approval_request.removeDeviceInstance = function(wcs, successcallback,errorcallback){
	...
	function approval_request_removeTransactioncallback(tx){
		...
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYAPPROVALS.approval_attachment.removeCascade, "approval_attachment", false, errorcallback, null, null, true)){
			...
			srcAttributes.push("id") ;
			targetAttributes.push("request_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYAPPROVALS.approval_audit.removeCascade, "approval_audit", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
/************************************************************************************
* Retrieves instances of approval_audit related to approval_request
* with given $relationship.getTargetObjectAttribute() from local database.
*************************************************************************************/

					
com.kony.MYAPPROVALS.approval_request.prototype.getapproval_auditWithrequest_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.prototype.getapproval_auditWithrequest_id function");
	var pks = this.getPKTable();
	com.kony.MYAPPROVALS.approval_request.getapproval_auditWithrequest_id(pks,successcallback,errorcallback);
};
com.kony.MYAPPROVALS.approval_request.getapproval_auditWithrequest_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.getapproval_auditWithrequest_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}		
	if(!kony.sync.validateInput(arguments, "com.kony.MYAPPROVALS.approval_request.getapproval_auditWithrequest_id",  "relationship", errorcallback)){
		return;
	}	
	function approval_request_successcallback(res){
		if(null!==res && res.length>0) {
			...
			function mySuccCallback(res){
									kony.sync.verifyAndCallClosure(mySuccesscallback, com.kony.MYAPPROVALS.approval_audit.convertTableToObject(kony.sync.filterNullsFromSelectResult(res)));
							}
...
/************************************************************************************
* Retrieves number of instances of approval_audit related to approval_request
* with given ${displayTargetAttribute} from local database.
*************************************************************************************/
com.kony.MYAPPROVALS.approval_request.prototype.getCountOfapproval_auditWithrequest_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.prototype.getCountOfapproval_auditWithrequest_id function");
	var pks = this.getPKTable();
	com.kony.MYAPPROVALS.approval_request.getCountOfapproval_auditWithrequest_id(pks,successcallback,errorcallback);
};
com.kony.MYAPPROVALS.approval_request.getCountOfapproval_auditWithrequest_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.getCountOfapproval_auditWithrequest_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.MYAPPROVALS.approval_request.getCountOfapproval_auditWithrequest_id",  "relationship", errorcallback)){
		return;
	}
	function approval_request_successcallback(res){
		if(null!==res && res.length>0) {
		   ...
		   com.kony.MYAPPROVALS.approval_audit.getCount(wClause, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.MYAPPROVALS.approval_request.prototype.getrequest_noteWithapproval_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.prototype.getrequest_noteWithapproval_id function");
	var pks = this.getPKTable();
	com.kony.MYAPPROVALS.approval_request.getrequest_noteWithapproval_id(pks,successcallback,errorcallback);
};
com.kony.MYAPPROVALS.approval_request.getrequest_noteWithapproval_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.getrequest_noteWithapproval_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}		
	if(!kony.sync.validateInput(arguments, "com.kony.MYAPPROVALS.approval_request.getrequest_noteWithapproval_id",  "relationship", errorcallback)){
		return;
	}	
	function approval_request_successcallback(res){
		if(null!==res && res.length>0) {
...
* with given ${displayTargetAttribute} from local database.
*************************************************************************************/
com.kony.MYAPPROVALS.approval_request.prototype.getCountOfrequest_noteWithapproval_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.prototype.getCountOfrequest_noteWithapproval_id function");
	var pks = this.getPKTable();
	com.kony.MYAPPROVALS.approval_request.getCountOfrequest_noteWithapproval_id(pks,successcallback,errorcallback);
};
com.kony.MYAPPROVALS.approval_request.getCountOfrequest_noteWithapproval_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYAPPROVALS.approval_request.getCountOfrequest_noteWithapproval_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.MYAPPROVALS.approval_request.getCountOfrequest_noteWithapproval_id",  "relationship", errorcallback)){
		return;
	}
	function approval_request_successcallback(res){
		if(null!==res && res.length>0) {
...
com.kony.MYAPPROVALS.approval_request.removeCascade = function(tx, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal){
	...
	function removeCascadeChildren(){
		...
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYAPPROVALS.approval_attachment.removeCascade, "approval_attachment", false, errorcallback, markForUpload, null, isLocal)){
			...
			srcAttributes.push("id") ;
			targetAttributes.push("request_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYAPPROVALS.approval_audit.removeCascade, "approval_audit", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
			var srcAttributes = [];
			var targetAttributes = [];
...
com.kony.MYAPPROVALS.approval_request.filterAttributes = function(valuestable, insert){
	...
	attributeTable.from_time = "from_time";
...
com.kony.MYAPPROVALS.approval_request.prototype.getValuesTable = function(isInsert){
	...
	valuesTable.from_time = this.from_time;
