/*
 * Model class for request_note object under MYAPPROVALS object service group
 ...
 */
kony.model.MYAPPROVALS.request_noteModel = (function(){
	
    function request_noteModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(request_noteModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof request_noteModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    request_noteModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    request_noteModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    request_noteModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    request_noteModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    request_noteModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    request_noteModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_noteModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    request_noteModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return request_noteModel;
})();