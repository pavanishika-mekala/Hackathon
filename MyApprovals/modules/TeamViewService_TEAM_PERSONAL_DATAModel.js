/*
 * Model class for TEAM_PERSONAL_DATA object under TeamViewService object service group
 ...
 */
kony.model.TeamViewService.TEAM_PERSONAL_DATAModel = (function(){
	
    function TEAM_PERSONAL_DATAModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(TEAM_PERSONAL_DATAModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof TEAM_PERSONAL_DATAModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    TEAM_PERSONAL_DATAModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    TEAM_PERSONAL_DATAModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    TEAM_PERSONAL_DATAModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    TEAM_PERSONAL_DATAModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    TEAM_PERSONAL_DATAModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    TEAM_PERSONAL_DATAModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_PERSONAL_DATAModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    TEAM_PERSONAL_DATAModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return TEAM_PERSONAL_DATAModel;
})();