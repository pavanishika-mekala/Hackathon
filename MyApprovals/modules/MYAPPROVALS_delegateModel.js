 ...
 */
kony.model.MYAPPROVALS.delegateModel = (function(){
	
    function delegateModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(delegateModel,kony.model.BaseModel);
    /**
     ...
     */
    delegateModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    delegateModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    delegateModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    delegateModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    delegateModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    delegateModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    delegateModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    delegateModel.prototype.validate = function(dataObject, validationType) {
