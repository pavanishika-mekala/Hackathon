...
kony.apps.coe.ess.Approvals.frmSearch.onClickFilterClearSearch = function() {
    ...
    frmSearch.calFromDate.dateComponents = [new Date().getDate(), new Date().getMonth() + 1, new Date().getFullYear()];
    frmSearch.calToDate.dateComponents = [new Date().getDate(), new Date().getMonth() + 1, new Date().getFullYear()];
