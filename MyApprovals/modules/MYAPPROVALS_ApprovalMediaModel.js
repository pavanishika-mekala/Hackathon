 ...
 */
kony.model.MYAPPROVALS.ApprovalMediaModel = (function(){
	
    function ApprovalMediaModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(ApprovalMediaModel,kony.model.BaseModel);
    /**
     ...
     */
    ApprovalMediaModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    ApprovalMediaModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    ApprovalMediaModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    ApprovalMediaModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    ApprovalMediaModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    ApprovalMediaModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ApprovalMediaModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    ApprovalMediaModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return ApprovalMediaModel;
})();