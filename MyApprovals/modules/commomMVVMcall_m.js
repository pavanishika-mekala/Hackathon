 ...
 * @throws Exception if something goes wrong,
 */
kony.apps.coe.ess.MVVM.partialUpdate = function(ModelName, dataobject, rowData, successcallback, errorcallback) {
	try {
		kony.print("--------------------in kony.apps.coe.ess.MVVM.update commomMVVMcalls_m.js");
		var objServiceInstance = kony.sdk.getCurrentInstance().getObjectService(ModelName, {
			"access": "online"
...
kony.apps.coe.ess.MVVM.deleteRecord =
    function(ModelName, dataobject, rowData, successcallback, errorcallback) {
        ...
        try {
          ...
          e.messaage = "MVVM Error at CommonMVVMcalls.js at delete Data";
            handleError(e);
        }
    };
/**
...
//serviceName - MYAPPROVALS , DataObject - ApprovalMedia 
kony.apps.coe.ess.MVVM.GetbinaryContent =
    function(serviceName, DataObject, mediaName, successCallback, errorCallback) {
