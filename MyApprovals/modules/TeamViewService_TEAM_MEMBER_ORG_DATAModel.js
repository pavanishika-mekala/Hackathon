/*
 * Model class for TEAM_MEMBER_ORG_DATA object under TeamViewService object service group
...
/**
 * Creates a new Model.
 * @class TEAM_MEMBER_ORG_DATAModel
 ...
 */
kony.model.TeamViewService.TEAM_MEMBER_ORG_DATAModel = (function(){
	
    function TEAM_MEMBER_ORG_DATAModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(TEAM_MEMBER_ORG_DATAModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof TEAM_MEMBER_ORG_DATAModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    TEAM_MEMBER_ORG_DATAModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return TEAM_MEMBER_ORG_DATAModel;
})();