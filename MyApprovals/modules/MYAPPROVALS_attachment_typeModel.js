/*
 * Model class for attachment_type object under MYAPPROVALS object service group
 ...
 */
kony.model.MYAPPROVALS.attachment_typeModel = (function(){
	
    function attachment_typeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(attachment_typeModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof attachment_typeModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    attachment_typeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    attachment_typeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    attachment_typeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    attachment_typeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    attachment_typeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    attachment_typeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attachment_typeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    attachment_typeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return attachment_typeModel;
})();