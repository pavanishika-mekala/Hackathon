 ...
 */
kony.model.MYAPPROVALS.attribute_sectionModel = (function(){
	
    function attribute_sectionModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(attribute_sectionModel,kony.model.BaseModel);
    /**
     ...
     */
    attribute_sectionModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    attribute_sectionModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    attribute_sectionModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    attribute_sectionModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    attribute_sectionModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    attribute_sectionModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attribute_sectionModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    attribute_sectionModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return attribute_sectionModel;
})();