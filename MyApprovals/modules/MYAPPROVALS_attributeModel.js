/*
 * Model class for attribute object under MYAPPROVALS object service group
 ...
 */
kony.model.MYAPPROVALS.attributeModel = (function(){
	
    function attributeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(attributeModel,kony.model.BaseModel);
    /**
     ...
     */
    attributeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    attributeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    attributeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    attributeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    attributeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    attributeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    attributeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    attributeModel.prototype.validate = function(dataObject, validationType) {
