/*
 * Model class for notification object under NotificationsApprovals object service group
 ...
 */
kony.model.NotificationsApprovals.notificationModel = (function(){
	
    function notificationModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(notificationModel,kony.model.BaseModel);
    /**
     ...
     */
    notificationModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    notificationModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    notificationModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    notificationModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    notificationModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    notificationModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notificationModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    notificationModel.prototype.validate = function(dataObject, validationType) {
