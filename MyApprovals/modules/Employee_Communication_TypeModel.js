/*
 * Model class for Communication_Type object under Employee object service group
 ...
 */
kony.model.Employee.Communication_TypeModel = (function(){
	
    function Communication_TypeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(Communication_TypeModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof Communication_TypeModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    Communication_TypeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    Communication_TypeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    Communication_TypeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    Communication_TypeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    Communication_TypeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    Communication_TypeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_TypeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    Communication_TypeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return Communication_TypeModel;
})();