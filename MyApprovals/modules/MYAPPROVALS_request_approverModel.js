/*
 * Model class for request_approver object under MYAPPROVALS object service group
 ...
 */
kony.model.MYAPPROVALS.request_approverModel = (function(){
	
    function request_approverModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(request_approverModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof request_approverModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    request_approverModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    request_approverModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    request_approverModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    request_approverModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    request_approverModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    request_approverModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_approverModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    request_approverModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return request_approverModel;
})();