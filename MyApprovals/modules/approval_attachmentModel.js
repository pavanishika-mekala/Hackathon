...
// ****************Generated On Mon Dec 11 21:58:45 UTC 2017approval_attachment*******************
...
com.kony.MYAPPROVALS.approval_attachment.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	if(record !== null){	
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYAPPROVALS.ApprovalMedia.removeCascade, "ApprovalMedia", false, errorcallback, markForUpload, record, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
