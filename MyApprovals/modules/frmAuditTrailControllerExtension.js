...
//             "left outer join employee emp3 on emp2.manager_id=emp3.id where aa.requestId='"+requestId + "';";
		...
		function successCallbackForAuditRecords(res) {
            ...
            var query = "select rn.comment as comments, rn.createdts as createdts, emp.First_Name as First_Name, emp.Last_Name as Last_Name from request_note rn left join Employee emp on rn.employee_id = emp.Id where rn.approval_id = '" + requestId + "';";
