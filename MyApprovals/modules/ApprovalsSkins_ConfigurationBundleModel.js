/*
 * Model class for ConfigurationBundle object under ApprovalsSkins object service group
...
/**
 * Creates a new Model.
 * @class ConfigurationBundleModel
 ...
 */
kony.model.ApprovalsSkins.ConfigurationBundleModel = (function(){
	
    function ConfigurationBundleModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(ConfigurationBundleModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof ConfigurationBundleModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    ConfigurationBundleModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    ConfigurationBundleModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    ConfigurationBundleModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    ConfigurationBundleModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    ConfigurationBundleModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    ConfigurationBundleModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    ConfigurationBundleModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    ConfigurationBundleModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return ConfigurationBundleModel;
})();