/*
 * Model class for Translation object under TranslationsService object service group
 ...
 */
kony.model.TranslationsService.TranslationModel = (function(){
	
    function TranslationModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(TranslationModel,kony.model.BaseModel);
    /**
     ...
     */
    TranslationModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    TranslationModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    TranslationModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    TranslationModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    TranslationModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    TranslationModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TranslationModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    TranslationModel.prototype.validate = function(dataObject, validationType) {
