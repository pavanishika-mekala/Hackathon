/*
 * Model class for Mapping object under MappingService object service group
 ...
 */
kony.model.MappingService.MappingModel = (function(){
	
    function MappingModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(MappingModel,kony.model.BaseModel);
    /**
     ...
     */
    MappingModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    MappingModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    MappingModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    MappingModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    MappingModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    MappingModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    MappingModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    MappingModel.prototype.validate = function(dataObject, validationType) {
