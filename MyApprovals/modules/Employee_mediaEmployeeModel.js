 ...
 */
kony.model.Employee.mediaEmployeeModel = (function(){
	
    function mediaEmployeeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(mediaEmployeeModel,kony.model.BaseModel);
    /**
     ...
     */
    mediaEmployeeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    mediaEmployeeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    mediaEmployeeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    mediaEmployeeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    mediaEmployeeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    mediaEmployeeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    mediaEmployeeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    mediaEmployeeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return mediaEmployeeModel;
})();