/*
 * Model class for notification_data object under NotificationsApprovals object service group
 ...
 */
kony.model.NotificationsApprovals.notification_dataModel = (function(){
	...
	inheritsFrom(notification_dataModel,kony.model.BaseModel);
    /**
     ...
     */
    notification_dataModel.prototype.getColumnNames = function() {
     ...
     */
    notification_dataModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    notification_dataModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    notification_dataModel.prototype.customVerb = function(verbName, options, success, error) {
