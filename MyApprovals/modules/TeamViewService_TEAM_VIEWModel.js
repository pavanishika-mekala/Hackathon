/*
 * Model class for TEAM_VIEW object under TeamViewService object service group
 ...
 */
kony.model.TeamViewService.TEAM_VIEWModel = (function(){
	
    function TEAM_VIEWModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(TEAM_VIEWModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof TEAM_VIEWModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    TEAM_VIEWModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    TEAM_VIEWModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    TEAM_VIEWModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    TEAM_VIEWModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    TEAM_VIEWModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    TEAM_VIEWModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_VIEWModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    TEAM_VIEWModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return TEAM_VIEWModel;
})();