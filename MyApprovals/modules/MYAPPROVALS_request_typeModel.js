/*
 * Model class for request_type object under MYAPPROVALS object service group
 ...
 */
kony.model.MYAPPROVALS.request_typeModel = (function(){
	
    function request_typeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(request_typeModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof request_typeModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    request_typeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    request_typeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    request_typeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    request_typeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    request_typeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    request_typeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    request_typeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    request_typeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return request_typeModel;
})();