/*
 * Controller Extension class for frmDelegationRequestList
 ...
 * @class frmDelegationRequestListControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmDelegationRequestListControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
     ...
     * @memberof frmDelegationRequestListControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
       ...
       function successCallbackSentByMe(res) {
        ...
        function success(dataSentByMe, dataReceived) {
            ...
            scopeObj.getController().processData({"dataSentByMe" : dataSentByMe, "dataReceived" : dataReceived});
        }
