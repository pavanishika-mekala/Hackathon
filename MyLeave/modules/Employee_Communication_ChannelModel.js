/*
 * Model class for Communication_Channel object under Employee object service group
...
/**
 * Creates a new Model.
 * @class Communication_ChannelModel
 ...
 */
kony.model.Employee.Communication_ChannelModel = (function(){
	
    function Communication_ChannelModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(Communication_ChannelModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof Communication_ChannelModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    Communication_ChannelModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    Communication_ChannelModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    Communication_ChannelModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    Communication_ChannelModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    Communication_ChannelModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    Communication_ChannelModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    Communication_ChannelModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    Communication_ChannelModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return Communication_ChannelModel;
})();