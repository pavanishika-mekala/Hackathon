/*
 * Controller Extension class for frmLeaveWallet
 ...
 * @class frmLeaveWalletControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmLeaveWalletControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
     ...
     * @memberof frmLeaveWalletControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    processData: function(data) {
        try {
            var scopeObj = this;
            var processedData = data;//this.$class.$superp.processData.call(this, data);
    ...
    bindData: function(data) {
        try {
            ...
            formmodel.clear();
             (new kony.apps.coe.ess.myLeave.leaveWallet()).processData(data);
