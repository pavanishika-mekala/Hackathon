...
// ****************Generated On Mon Jul 24 09:45:25 UTC 2017leave_attachments*******************
...
com.kony.MYLEAVE.leave_attachments.prototype = {
	...
	set LV_ATTCH_SEQNO(val){
		if(!kony.sync.isEmptyString(val) && !kony.sync.isNull(val) && !kony.sync.isValidNumberType(val)){
			sync.log.error("Invalid data type for the attribute LV_ATTCH_SEQNO in leave_attachments.\nExpected:\"double\"\nActual:\"" + kony.type(val) + "\"");
		}
...
*		valuesArray[0].LV_ATTCH_SEQNO = 0;
...
*		valuesArray[1].LV_ATTCH_SEQNO = 1;
...
*		valuesArray[2].LV_ATTCH_SEQNO = 2;
...
com.kony.MYLEAVE.leave_attachments.validateNull = function (valuestable,errorcallback){
	...
	if(valuestable.media_id!==undefined){
...
com.kony.MYLEAVE.leave_attachments.getRelationshipMap = function(relationshipMap,valuestable){
	...
	if (!kony.sync.isNullOrUndefined(valuestable.leavel_id)){
		r1.sourceAttribute.push("id");
		r1.foreignKeyAttribute.push("leavel_id");
		r1.targetAttributeValue.push("'" + valuestable.leavel_id + "'");
	}
