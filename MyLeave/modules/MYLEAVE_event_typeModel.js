/*
 * Model class for event_type object under MYLEAVE object service group
 ...
 */
kony.model.MYLEAVE.event_typeModel = (function(){
	
    function event_typeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(event_typeModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof event_typeModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    event_typeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    event_typeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    event_typeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    event_typeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    event_typeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    event_typeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    event_typeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    event_typeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return event_typeModel;
})();