/*
 * Model class for TEAM_LEAVE_NOTE object under TeamViewService object service group
 ...
 */
kony.model.TeamViewService.TEAM_LEAVE_NOTEModel = (function(){
	
    function TEAM_LEAVE_NOTEModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(TEAM_LEAVE_NOTEModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof TEAM_LEAVE_NOTEModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    TEAM_LEAVE_NOTEModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    TEAM_LEAVE_NOTEModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    TEAM_LEAVE_NOTEModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    TEAM_LEAVE_NOTEModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    TEAM_LEAVE_NOTEModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    TEAM_LEAVE_NOTEModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    TEAM_LEAVE_NOTEModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    TEAM_LEAVE_NOTEModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return TEAM_LEAVE_NOTEModel;
})();