...
addCalendarOnLeaveHome = function() {
  try {
    kony.print("-- Start addCalendarOnLeaveHome in ApplyLeaveHome --");
...
MyLeaveHomeUI.getWeeksInMonth = function(month, year) {
  ...
  if(Number(firstDate.getDay()) === 0){
    noOfWeeks = Number(weeks.length)+1;
  }
  return noOfWeeks;
};
...
MyLeaveHomeUI.shiftMonthDetailsFlex = function(weeksInMonth) {
  ...
  //commented below code as the last line was getting truncated in diff resolution devices
  //   	if (weeksInMonth === 6) {
  //         frmLeaveHome.flxLeaveMonthDetailsMain.height = 44 + "%";
  //         frmLeaveHome.flxLeaveMonthDetailsMaintop = 56 + "%";
  //       	frmLeaveHome.flxLeaveMonthDetailsMain.forceLayout();
  //     } else if (weeksInMonth === 5) {
  //         frmLeaveHome.flxLeaveMonthDetailsMain.height = 49 + "%";
  //         frmLeaveHome.flxLeaveMonthDetailsMain.top = 51 + "%";
  //       	frmLeaveHome.flxLeaveMonthDetailsMain.forceLayout();
  //     }
  //   	else if (weeksInMonth === 4) {
  //         frmLeaveHome.flxLeaveMonthDetailsMain.height = 54 + "%";
  //         frmLeaveHome.flxLeaveMonthDetailsMain.top = 46 + "%";
  //       	frmLeaveHome.flxLeaveMonthDetailsMain.forceLayout();
  //     }
};
/**
