/*
 * Model class for employee_leave_type object under MYLEAVE object service group
...
/**
 * Creates a new Model.
 * @class employee_leave_typeModel
 ...
 */
kony.model.MYLEAVE.employee_leave_typeModel = (function(){
	
    function employee_leave_typeModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(employee_leave_typeModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof employee_leave_typeModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    employee_leave_typeModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    employee_leave_typeModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    employee_leave_typeModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    employee_leave_typeModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    employee_leave_typeModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    employee_leave_typeModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    employee_leave_typeModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    employee_leave_typeModel.prototype.validate = function(dataObject, validationType) {
        return kony.model.BaseModel.prototype.validate.call(this, dataObject, validationType);
    }
	
	return employee_leave_typeModel;
})();