/*
 * Model class for Holiday object under Employee object service group
 ...
 */
kony.model.Employee.HolidayModel = (function(){
	
    function HolidayModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(HolidayModel,kony.model.BaseModel);
    /**
     ...
     */
    HolidayModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    HolidayModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    HolidayModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    HolidayModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    HolidayModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    HolidayModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    HolidayModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    HolidayModel.prototype.validate = function(dataObject, validationType) {
