...
// ****************Generated On Mon Dec 11 21:45:46 UTC 2017leave*******************
...
com.kony.MYLEAVE.leave.deleteByPK = function(pks, successcallback,errorcallback, markForUpload){
	...
	function leaveTransactionCallback(tx){
		...
		if (null !== record) {
			...
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_attachments.removeCascade,"leave_attachments",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			...
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_audit.removeCascade,"leave_audit",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			var srcAttributes = [];
			var targetAttributes = [];
			srcAttributes.push("employee_id") ;
			targetAttributes.push("employee_id") ;
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_note.removeCascade,"leave_note",false, errorcallback, markForUpload, record, false)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.MYLEAVE.leave.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	if(record !== null){	
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_attachments.removeCascade, "leave_attachments", false, errorcallback, markForUpload, record, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
	...
	if(record !== null){	
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_audit.removeCascade, "leave_audit", false, errorcallback, markForUpload, record, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
	...
	if(record !== null){	
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_note.removeCascade, "leave_note", false, errorcallback, markForUpload, record, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
com.kony.MYLEAVE.leave.removeDeviceInstanceByPK = function(pks, successcallback,errorcallback){
	...
	function leaveTransactionCallback(tx){
		...
		if(null !== record && false !=record) {
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leavel_id") ;
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_attachments.removeCascade,"leave_attachments",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_audit.removeCascade,"leave_audit",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
			if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, "", com.kony.MYLEAVE.leave_note.removeCascade,"leave_note",false, errorcallback, null, record, true)){
				isError = true;	
				kony.sync.rollbackTransaction(tx);
				return;
			}
...
com.kony.MYLEAVE.leave.removeDeviceInstance = function(wcs, successcallback,errorcallback){
	...
	function leave_removeTransactioncallback(tx){
		wcs = " " + wcs;
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leavel_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_attachments.removeCascade, "leave_attachments", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_audit.removeCascade, "leave_audit", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_note.removeCascade, "leave_note", false, errorcallback, null, null, true)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}
...
com.kony.MYLEAVE.leave.prototype.getleave_attachmentsWithleavel_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getleave_attachmentsWithleavel_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getleave_attachmentsWithleavel_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getleave_attachmentsWithleavel_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getleave_attachmentsWithleavel_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}		
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getleave_attachmentsWithleavel_id",  "relationship", errorcallback)){
		return;
	}	
...
*************************************************************************************/
com.kony.MYLEAVE.leave.prototype.getCountOfleave_attachmentsWithleavel_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getCountOfleave_attachmentsWithleavel_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getCountOfleave_attachmentsWithleavel_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getCountOfleave_attachmentsWithleavel_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getCountOfleave_attachmentsWithleavel_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getCountOfleave_attachmentsWithleavel_id",  "relationship", errorcallback)){
		return;
	}
	function leave_successcallback(res){
		if(null!==res && res.length>0) {
...
/************************************************************************************
* Retrieves instances of leave_audit related to leave
* with given $relationship.getTargetObjectAttribute() from local database.
*************************************************************************************/

					
com.kony.MYLEAVE.leave.prototype.getleave_auditWithleave_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getleave_auditWithleave_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getleave_auditWithleave_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getleave_auditWithleave_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getleave_auditWithleave_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}		
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getleave_auditWithleave_id",  "relationship", errorcallback)){
		return;
	}	
	function leave_successcallback(res){
		if(null!==res && res.length>0) {
			var wcs = [];
			var targetKey_0 = res[0].id;				
			wcs.push({key:"leave_id", value:targetKey_0});		
			...
			function mySuccCallback(res){
									kony.sync.verifyAndCallClosure(mySuccesscallback, com.kony.MYLEAVE.leave_audit.convertTableToObject(kony.sync.filterNullsFromSelectResult(res)));
							}
...
/************************************************************************************
* Retrieves number of instances of leave_audit related to leave
* with given ${displayTargetAttribute} from local database.
*************************************************************************************/
com.kony.MYLEAVE.leave.prototype.getCountOfleave_auditWithleave_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getCountOfleave_auditWithleave_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getCountOfleave_auditWithleave_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getCountOfleave_auditWithleave_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getCountOfleave_auditWithleave_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getCountOfleave_auditWithleave_id",  "relationship", errorcallback)){
		return;
	}
	function leave_successcallback(res){
		if(null!==res && res.length>0) {
		   ...
		   com.kony.MYLEAVE.leave_audit.getCount(wClause, successcallback,errorcallback);
		}else{
			kony.sync.verifyAndCallClosure(successcallback,{"count":0});
			return;
		}
...
com.kony.MYLEAVE.leave.prototype.getleave_noteWithemployee_idANDleave_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getleave_noteWithemployee_idANDleave_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getleave_noteWithemployee_idANDleave_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getleave_noteWithemployee_idANDleave_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getleave_noteWithemployee_idANDleave_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}		
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getleave_noteWithemployee_idANDleave_id",  "relationship", errorcallback)){
		return;
	}	
	function leave_successcallback(res){
		if(null!==res && res.length>0) {
...
* with given ${displayTargetAttribute} from local database.
*************************************************************************************/
com.kony.MYLEAVE.leave.prototype.getCountOfleave_noteWithemployee_idANDleave_id  = function(successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.prototype.getCountOfleave_noteWithemployee_idANDleave_id function");
	var pks = this.getPKTable();
	com.kony.MYLEAVE.leave.getCountOfleave_noteWithemployee_idANDleave_id(pks,successcallback,errorcallback);
};
com.kony.MYLEAVE.leave.getCountOfleave_noteWithemployee_idANDleave_id = function(pks,successcallback,errorcallback){
	sync.log.trace("Entering com.kony.MYLEAVE.leave.getCountOfleave_noteWithemployee_idANDleave_id function");
	if(!kony.sync.isSyncInitialized(errorcallback)){
		return;
	}
	if(!kony.sync.validateInput(arguments, "com.kony.MYLEAVE.leave.getCountOfleave_noteWithemployee_idANDleave_id",  "relationship", errorcallback)){
		return;
	}
	function leave_successcallback(res){
		if(null!==res && res.length>0) {
...
com.kony.MYLEAVE.leave.removeCascade = function(tx, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal){
	...
	function removeCascadeChildren(){
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leavel_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_attachments.removeCascade, "leave_attachments", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
			var srcAttributes = [];
			var targetAttributes = [];
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_audit.removeCascade, "leave_audit", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
			var srcAttributes = [];
			var targetAttributes = [];
			...
			srcAttributes.push("id") ;
			targetAttributes.push("leave_id") ;
		if(!kony.sync.removeCascadeHelper(tx, srcAttributes, targetAttributes, tbname, wcs, com.kony.MYLEAVE.leave_note.removeCascade, "leave_note", false, errorcallback, markForUpload, null, isLocal)){
			return false;
		}
	}
	if(isCascade){
