...
//forms and their corresponding headers
    var formsAndHeaderHeights={
       "frmApplyLeave":"flxHeader",
       "frmAuditTrail":"flxAuditTrailHeader",
       "frmHolidays":"flxHeader",
       "frmLeaveBalance":"flxHeader",
       "frmLeaveHome":"flxLeaveHomeHeader",
       "frmLeaveRequestDetails":"flxHeader",
       "frmLeaveWallet":"flxHeader",
       "frmNotificationsList":"flxHeader",
       "frmPendingLeaveRequest":"flxHeader",
       "frmSearchLeaveType":"flxHeader",
       "frmSearchLog":"flxHeader",
       "frmSettings":"flxHeader",
       "frmStatusSearch":"flxHeader",
       "frmTeamView":"flxHeader",
     };
...
kony.apps.coe.ess.Sync.UI.startSyncProgressBar = function() { 
  ...
  //kony.apps.coe.ess.Sync.UI.setProgressPercentage(10);
...
kony.apps.coe.ess.Sync.UI.stopSyncProgressBarWithErrorMessage = function() {
  kony.apps.coe.ess.Sync.UI.showErrorToast(kony.i18n.getLocalizedString("i18n.ess.commom.sync.errorOccured") , function(){
