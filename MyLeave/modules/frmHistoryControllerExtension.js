...
kony.sdk.mvvm.frmHistoryControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
    ...
    processData: function(data) {
        try {
            var scopeObj = this;
            var processedData = (new kony.apps.coe.myLeave.leaveHistory()).processHistoryData(data);
            (new kony.apps.coe.myLeave.leaveHistory()).setDataToDynamicSegments();
    ...
    bindData: function(data) {
        try {
            ...
            formmodel.clear();
            frmHistory.segRepoData.setData(data);
