    ...
    onClickOfLeaveType: function(id) {
        ...
        kony.sync.single_select_execute(kony.sync.getDBName(), sqlquery, null, function(data) {
            if (data.length > 0 && data !== undefined && data[0].balance !== undefined) {
                ...
                frmApplyLeave.lblLeaveTypeBalance.text = "Available " + id/*frmApplyLeave[eventobject.id].text */+ " leave";
...
kony.apps.coe.ess.myLeave.applyLeave.RecurringLeave = {
    ...
    onClickOfWeekly: function() {
        ...
        var btnFirstWeek = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_15ab21a85808463382e51a0b8dba4a02,
        ...
        var btnSecondWeek = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_729cb3aac1a64553849c00a3f985d223,
        ...
        var btnSunday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_778c45b0e3954180aa15c394d2ddaa0e,
        ...
        var btnMonday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_72819b6b1d554c8fb99503bd158fdd13,
            "skin": "sknMobBtn777777Px28",
            "text": "Mo",
            "top": "10%",
            "width": "11%",
        ...
        var btnTuesday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_4316530912c249b9ba73a65b05a6b53b,
            "skin": "sknMobBtn777777Px28",
            "text": "Tu",
            "top": "10%",
            "width": "11%",
        ...
        var btnWednesday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_3f388530a9e44896b852a2a3be241812,
            "skin": "sknMobBtn777777Px28",
            "text": "We",
            "top": "10%",
            "width": "11%",
        ...
        var btnThursday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_ad1ebd41315d45ceaf575d5c68ff56b4,
            "skin": "sknMobBtn777777Px28",
            "text": "Th",
            "top": "10%",
            "width": "11%",
        ...
        var btnFriday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_a790a3d2ad524d2f8f3f78706f85b5f6,
            "skin": "sknMobBtn777777Px28",
            "text": "Fr",
            "top": "10%",
            "width": "11%",
        ...
        var btnSaturday = new kony.ui.Button({
            ...
            "isVisible": true,
            "left": "0%",
            "onClick": AS_Button_cd9098e89c004c3291aa7a5cb2cfa52f,
            "skin": "sknMobBtn777777Px28",
            "text": "Sa",
            "top": "10%",
            "width": "11%",
